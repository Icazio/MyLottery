...
/**
 * @author Icarus
 * @description 奖品单【用户ID、活动领取ID、订单ID、策略ID、策略方式（1:单项概率、2:总体概率）、发放奖品方式（1:即时、2:定时[含活动结束]、3:人工）、发奖时间、发奖状态、发奖ID、奖品类型（1:文字描述、2:兑换码、3:优惠券、4:实物奖品）、奖品名称、奖品内容「文字描述、Key、码」】
 * @date 2023/4/3 20:53
 */
